...
#         plt.pause(0.001)
        ...
        ax_traj.plot(t.numpy(), true_y.numpy()[:, 1], t.numpy(), true_y.numpy()[:, 2], t.numpy(), true_y.numpy()[:, 3], 'g-')
        ax_traj.plot(t.numpy(), pred_y.numpy()[:, 1], '--', t.numpy(), pred_y.numpy()[:, 2], t.numpy(), pred_y.numpy()[:, 3], 'b--')
        ax_traj.set_xlim(t.min(), t.max())
